...
export function AddSemesterModal({ isOpen, onClose, onSubmit }: AddSemesterModalProps) {
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <div className="relative px-6 pt-6 pb-4 border-b border-slate-100">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-slate-900">Add New Semester</h2>
                  <p className="text-sm text-slate-500 mt-0.5">Create a new academic semester</p>
                </div>
              </div>
              <button
                onClick={onClose}
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="px-6 pb-6 overflow-y-auto max-h-[calc(90vh-180px)]">
            {/* Semester Name */}
            <div className="mb-4">
