...
// UI components not needed in new design
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between py-4 md:py-5">
            ...
            <nav className="hidden md:flex items-center gap-8 absolute left-1/2 transform -translate-x-1/2">
              <Link to="/demo" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Demo</Link>
              <Link to="/manuals" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Documentation</Link>
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 ml-auto">
              ...
              <Link to="/register/university-admin">
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden border-t border-gray-100 py-4 space-y-3">
              <Link to="/login" className="block text-gray-700 hover:text-gray-900 py-2 transition-colors">
                Sign In
              </Link>
              <Link to="/demo" className="block text-gray-600 hover:text-gray-900 py-2 transition-colors">
                Demo
              </Link>
              <Link to="/manuals" className="block text-gray-600 hover:text-gray-900 py-2 transition-colors">
                Documentation
              </Link>
              <button 
      ...
      <div className="bg-gray-50 py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            <Link to="/register-superadmin" className="group bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-200">
            ...
            <Link to="/register/university-admin" className="group bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-200">
            ...
            <Link to="/login" className="group bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-200">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="space-y-2 sm:space-y-3">
                <Link to="/feedback" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Student Feedback
                </Link>
                <Link to="/login" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Admin Login
                </Link>
                <Link to="/register/university-admin" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Register
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 sm:space-y-3">
                <Link to="/manuals" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Documentation
                </Link>
                <Link to="/demo" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Demo
                </Link>
                <Link to="/student-reviews" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Analytics
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <Link to="/terms" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Terms
                </Link>
                <Link to="/privacy" className="block text-gray-600 hover:text-gray-900 text-xs sm:text-sm transition-colors">
                  Privacy
                </Link>
              </div>
            </div>
