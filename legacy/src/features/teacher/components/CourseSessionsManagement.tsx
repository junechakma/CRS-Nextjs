...
export interface CourseSessionsManagementRef {
...
const SessionModal: React.FC<SessionModalProps> = ({ isOpen, onClose, session, course, questions, durations, onSubmit }) => {
...
const CourseSessionsManagement = forwardRef<CourseSessionsManagementRef, CourseSessionsManagementProps>(({ courseId, course }, ref) => {
...
CourseSessionsManagement.displayName = 'CourseSessionsManagement'
